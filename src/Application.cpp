...
static const float ASTEROID_CURVE_SPEED = 0.45f;
static const float ASTEROID_CURVE_T_AMPLITUDE = 0.5f;
static const float ASTEROID_CURVE_T_OFFSET = 1.0f;

static const glm::vec4 ASTEROID_CURVE_P0 = glm::vec4(15.0f, 2.0f, -20.0f, 1.0f);
static const glm::vec4 ASTEROID_CURVE_P1 =
    glm::vec4(28.0f, 14.0f, -34.0f, 1.0f);
static const glm::vec4 ASTEROID_CURVE_P2 =
    glm::vec4(-18.0f, 18.0f, -48.0f, 1.0f);
static const glm::vec4 ASTEROID_CURVE_P3 =
